...
$query="select * from doctor where specialized_area='VP' " ;
$query2 = "SELECT image from login where abstype='VP'";
    ...
    <div class="row">
          <div class="col-md-3">
            <div class="card" style="margin-top:10px; margin-left:10px;">
              <?php
                   $con=mysqli_connect("localhost","root","","suwapiyasa");
                   $query = "SELECT image from login where abstype='VP'";
                   $result = mysqli_query($con,$query);
                   while($row= mysqli_fetch_array($result)){
              ...
              ?>
               <div class="container">
                 ...
                 <?php
            					...
            					$date =date("Y-m-d");
            					$sql="SELECT count(nic_no) AS total FROM appointment WHERE doctor='VP' and date='$date'";
          ...
          <div class="col-md-8">
            <div class="sub_nav">
              <ul>
                ...
                <li id="view_his"><a href="vp-patienthistory.php" style="text-decoration:none;color:#fff">Patient History</a></li>
              </ul>
            </div>
              ...
              <div id="appoitments" style="display:none;">
                  					...
                  					<table class="table table-hover"style="margin-top:10px;background-color:#262626;color:black;">
                  						<thead>
                  						  ...
                  						  <tbody>
                  							<?php
                  								$con=mysqli_connect("localhost","root","","suwapiyasa");
                  								$query="select * from appointment WHERE doctor='VP'";
                  								$result=mysqli_query($con,$query);
                  								while($row=mysqli_fetch_array($result)){
                  								$fname = $row['fname'];
                  								$lname = $row['lname'];
                ...
                <div id="mg-profile" style="display:none;">
                  ...
                  <form class="form-group" action="vpfunc.php" method="post" enctype="multipart/form-data">
                ...
                <div id="patients" style="display:none;">
                  <form class="form-group" action="" method="post">
                          ...
                          if(isset($_POST['register'])){
                            ...
                            $date = date("Y-m-d");
                            $query = "INSERT INTO apmt_vp(fname,lname,nic_no,contact,priscription,date)values('$fname','$lname','$nic','$phone','$priscription','$date')";
                            $result=mysqli_query($con,$query);
                            if($result){
                              echo "<script>alert('Registered')</script>";
                              echo "<script>window.open('vp.php','_self')</script>";
                            }else{
