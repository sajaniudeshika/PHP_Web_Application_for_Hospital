...
<html lang="en">
  <head>
   <title>Cardiologist-patient History</title>
   <meta charset="utf-8">
    ...
    <div class="row">
      ...
      <div class="col-md-10">
				<div class="card">
    				...
    				<form action="cardi-patienthistory.php" method="post">
      					<?php
      						if(isset($_POST['search']))
      						{
      							$valueToSearch = $_POST['valueToSearch'];
      							$query="SELECT * FROM apmt_cardi WHERE nic_no='$valueToSearch'";
      							$search_result = filterTable($query);
      						}
      						else{
      							$query="SELECT * FROM apmt_cardi";
      							$search_result = filterTable($query);
      						}
