...
<html lang="en">
  <head>
   <title>VP-patient History</title>
   <meta charset="utf-8">
    ...
    <div class="row">
      ...
      <div class="col-md-10">
				<div class="card">
    				...
    				<form action="vp-patienthistory.php" method="post">
      					<?php
      						if(isset($_POST['search']))
      						{
      							$valueToSearch = $_POST['valueToSearch'];
      							$query="SELECT * FROM apmt_vp WHERE nic_no='$valueToSearch'";
      							$search_result = filterTable($query);
      						}
      						else{
      							$query="SELECT * FROM apmt_vp";
      							$search_result = filterTable($query);
      						}
