...
if(isset($_POST['edit_profile'])){
  ...
  $query1 = "UPDATE doctor Set contact='$phone', time='$time',hospital='$hospital' WHERE specialized_area='EYE'";
  $result=mysqli_query($con,$query1);
  if($result){
    $encripted_pass = sha1($password);
    $query2 = "UPDATE login Set username='$username',password='$encripted_pass',image='$image' WHERE abstype='EYE'";
